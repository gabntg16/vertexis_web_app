// lib/screens/branch/branch_calendar.dart
...
class BranchCalendar extends StatefulWidget {
  const BranchCalendar({super.key});

  @override
  State<BranchCalendar> createState() => _BranchCalendarState();
}

class _BranchCalendarState extends State<BranchCalendar> {
  ...
  Future<void> _showAddEventDialog(
    ...
    final branch = svc.getBranch(svc.currentUser!.branchId!)!;
                        ...
                        children: [
                          TextFormField(
                            ...
                            decoration: const InputDecoration(
                              labelText: 'Title',
                              hintText: 'Batch production or client visit',
                            ),
                            validator: (value) {
                              ...
                              Expanded(
                                child: ElevatedButton(
                                  onPressed: () {
                                    ...
                                    showSnack(context,
                                        '${eventType.label} scheduled successfully');
                                  },
  ...
  Widget build(BuildContext context) {
    ...
    final dayEvents =
        svc.branchEvents.where((e) => isSameDay(e.date, selected)).toList();

    return Scaffold(
      appBar: AppBar(title: const Text('Calendar')),
      floatingActionButton: FloatingActionButton.extended(
        heroTag: 'branch_calendar_fab',
                  ...
                  Card(
                    child: Padding(
                      ...
                      child: TableCalendar(
                        ...
                        eventLoader: (day) => svc.branchEvents
          ...
          if (dayEvents.isEmpty)
            const SliverFillRemaining(
              ...
              child: EmptyState(
                  ...
                  message: 'No events on this day. Tap + to schedule tasks.'),
            )
          else
            SliverPadding(
